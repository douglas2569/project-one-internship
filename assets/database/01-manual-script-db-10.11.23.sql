...
insert INTo employees (cpf, name, address, phone_number, email, position, auto_vehicle_workshops_id) 
...
CREATE VIEW v_users 
AS SELECT users.cpf, users.username, users.password, employees.name, users.status FROM users 

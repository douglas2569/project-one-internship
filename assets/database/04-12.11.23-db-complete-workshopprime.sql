...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 12-Nov-2023 às 12:04
...
(41, '77777777777', 'Denies Kleites', '', '15111876541', 'denies@gmail.com', 35);
...
(42, '00000000024', 'Guilherme', '', '85119876524', 'gui@gmail.com', 35, 35),
...
(35, 'Carro não liga', 'Quando giro a chave ele faz tantaaaatan', 0, NULL, NULL, 'MXQ9131'),
(36, 'Pneu vazio', 'Passei por cima de um prego', 0, NULL, NULL, 'LST5307'),
(37, 'farol esquerdo piscando', 'uma bola bateu nele', 0, NULL, NULL, 'HPP2304'),
(39, 'pouco barulho', 'tatatatatatasdasd', 0, NULL, NULL, 'XXX0000');
...
(39, NULL, NULL, 2, 37, 39, 36),
(40, NULL, NULL, 1, 36, 40, 37),
(43, NULL, NULL, 2, 35, 43, 35),
(44, NULL, NULL, 3, 35, 39, 35);
...
CREATE TABLE IF NOT EXISTS `suppliers` (
  ...
  `phone_number` varchar(50) NOT NULL,
  `email` varchar(255) NOT NULL,
  `brach_activity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `auto_vehicle_workstops_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cnpj` (`cnpj`),
  UNIQUE KEY `name` (`name`),

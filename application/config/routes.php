...
$route['maintenance/workon/(:any)'] = 'Maintenance_controller/workOn/$1';
...
$route['maintenanceinventory/destroy/(:num)/(:num)/(:any)/(:num)'] = 'Maintenance_Inventory_controller/destroy/$1/$2/$3/$4'; 
